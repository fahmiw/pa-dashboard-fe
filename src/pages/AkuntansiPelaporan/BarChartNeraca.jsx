...
export default function BarChartNeraca({ height = "h-56" }) {
  ...
  const categories = ["Aset", "Kewajiban","Ekuitas"];

    const neraca2024 = [
      neraca[2024].aset,
      neraca[2024].kewajiban,
      neraca[2024].ekuitas,
    ];
    const neraca2025 = [
      neraca[2025].aset,
      neraca[2025].kewajiban,
      neraca[2025].ekuitas
    ];
      ...
      <div className="rounded-md border border-gray-200 overflow-hidden">
        <table className="w-full text-[11px]">
          ...
          <tr className="odd:bg-white even:bg-gray-50">
            ...
            <td className="px-2 py-1 border-b">
              {neraca[2024].kewajiban.toLocaleString("id-ID")}
            </td>
            <td className="px-2 py-1 border-b">
          ...
          <tr className="odd:bg-white even:bg-gray-50">
            ...
            <td className="px-2 py-1">
              {neraca[2025].kewajiban.toLocaleString("id-ID")}
            </td>
            <td className="px-2 py-1">
